...
public class starMatrix1 {

    static void printDiagonalMatrix(int argRow, int argCol, boolean isBidirectional) {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            while(true) {
                ...
                System.out.println("재입력하세요. 1~4 범위 내 정수 값을 입력하세요.");
            }
            ...
            // 좌상단->우하단 대각선 삭제 후 M X col Matrix 출력
                ...
                printDiagonalMatrix(row, col, false);
            }

            // 만약 3을 선택했을 경우
            // 좌상단->우하단 + 우상단->좌하단 대각선 삭제 후 M X col Matrix 출력
            else {
                printDiagonalMatrix(row, col, true);
            }
